...
<body>
    ...
    <div class="text-center container">
        ...
        <form class="formulario" action="../controller/controladorEliminar.php" method="POST"
            ...
            <br /><br />
            <button class="btn btn-danger my-3" type="submit" name="valor" value="buscarCodigo">Buscar</button>
        </form>
        ...
        <form class="formulario" action="../controller/controladorEliminar.php" method="POST"
            id="formularioConsultaNombre">
            <!-- codigo, nombre y sucursal -->
            <label for="nombreProducto">Nombre del producto: </label>
            <input class="input w-25" type="text" name="nombreProducto" id="inputNombreProducto" />
            <br /><br />
            <button class="btn btn-danger my-3" type="submit" name="valor" value="buscarNombre">Buscar</button>
        </form>
        ...
        <form class="formulario" action="../controller/controladorEliminar.php" method="POST"
            ...
            <br /><br />
            <button class="btn btn-danger my-3" type="submit" name="valor" value="buscarSucursal">Buscar</button>
        </form>
    </div>
