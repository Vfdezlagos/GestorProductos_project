...
<body>
    ...
    <div class="text-center container">
        ...
        if (isset($_GET['Status'])) {
            ...
            echo "<h2 class='text-danger'>$Status</h2>";
        }
        ?>

        <h2 class="mt-5 mb-3">Buscar por codigo</h2>
        <form class="formulario" action="../controller/controladorActualizar.php" method="POST" id="formularioConsultaCodigo">
            ...
            <br /><br />
            <button class="btn btn-warning my-3" type="submit" name="valor" value="buscarCodigo">Buscar</button>
        </form>

        <br /><br />

        <h2>Buscar por nombre</h2>
        <form class="formulario" action="../controller/controladorActualizar.php" method="POST" id="formularioConsultaNombre">
            <!-- codigo, nombre y sucursal -->
            <label for="nombreProducto">Nombre del producto: </label>
            <input class="input w-25" type="text" name="nombreProducto" id="inputNombreProducto" />
            <br /><br />
            <button class="btn btn-warning my-3" type="submit" name="valor" value="buscarNombre">Buscar</button>
        </form>

        <br /><br />

        <h2>Buscar por sucursal</h2>
        <form class="formulario" action="../controller/controladorActualizar.php" method="POST" id="formularioConsultaSucursal">
            <!-- codigo, nombre y sucursal -->
            ...
            <br /><br />
            <button class="btn btn-warning my-3" type="submit" name="valor" value="buscarSucursal">Buscar</button>
        </form>
    </div>
